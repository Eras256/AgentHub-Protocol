          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:block">
              <ConnectButton
                ...
                className="!bg-gradient-to-r !from-purple-600 !to-cyan-600 hover:!from-purple-500 hover:!to-cyan-500 !transition-all !duration-300 !rounded-lg !px-6 !py-3 !font-semibold"
              />
            </div>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="fixed top-20 left-0 right-0 z-40 md:hidden backdrop-blur-xl bg-black/90 border-b border-white/10"
          >
            <div className="px-4 py-6 space-y-3">
              ...
              <div className="pt-4">
                <ConnectButton
                  theme="dark"
                  btnTitle="Connect Wallet"
                  className="!w-full !bg-gradient-to-r !from-purple-600 !to-cyan-600 !rounded-lg !py-3"
                />
              </div>
            </div>
          </motion.div>
